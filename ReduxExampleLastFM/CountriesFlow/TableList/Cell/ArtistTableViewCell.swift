...
class ArtistTableViewCell: UITableViewCell, ReusableView {
    
    static let identifier = "\(ArtistTableViewCell.self)"
    
    static var nib: UINib {
        return UINib(nibName: ArtistTableViewCell.identifier, bundle: nil)
    }
